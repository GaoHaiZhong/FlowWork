        ...
        <c:if test="${!hasFormKey}">
            <c:forEach items="${taskFormData.formProperties}" var="fp">
                ...
                <%
                    ...
                    FormType type = ((FormProperty)application.getAttribute("fpo")).getType();
                    String[] keys = {"datePattern", "values"};
                    for (String key: keys) {
                        application.setAttribute(key, type.getInformation(key));
        ...
        <div class="control-group">
            <div class="controls">
              ...
              <%--  <c:if test="${not empty flowBean.taskEntity.assignee}">
                ...
                <c:if test="${empty flowBean.taskEntity.assignee}">
                    <a class="btn" href="${ctx }/${flowBean.processDefinitionEntity.key}/task/claim/${flowBean.taskEntity.id}?nextDo=handle"><i class="icon-ok"></i>签收</a>
                </c:if>
            </div>
        </div>
    </form>
