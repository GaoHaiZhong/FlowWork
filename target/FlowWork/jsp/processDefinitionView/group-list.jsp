    ...
    <script type="text/javascript">
        $(function() {
            $('.edit-group').click(function() {
                ...
                $('#groupKey').val($tr.find('.prop-key').text());
            });
        });
    </script>
</head>
...
<ul class="nav nav-pills">
    <li><a href="${ctx}/identity/toUserList.actio"><i class="icon-user"></i>用户管理</a></li>
    <li class="active"><a href="${ctx}/identity/toRollerList.action"><i class="icon-list"></i>组管理</a></li>
...
<div class="row">
            ...
            <table width="100%" class="table table-bordered table-hover table-condensed">
                ...
                <c:forEach items="${page.result }" var="group">
                    <tr id="${group.id}">
                        ...
                        <td class="prop-name">${group.rolername}</td>
                        <td class="prop-key">${group.keyname}</td>
                        <td class="prop-type">
                           <%-- <c:if test="${not empty group.type}">
                                ${group.type}
                            </c:if>--%>
                        </td>
                        <td>
                            <a class="btn btn-danger btn-small" href="${ctx}/identity/identity//deleteRoler/${group.id}"><i class="icon-remove"></i>删除</a>
    ...
    <div class="span4">
        <form action="${ctx }/identity/saveRoler.action" class="form-horizontal" method="post">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="groupId" name="id" class="required" />
                    </div>
                </div>
                <div class="control-group">
                    <label for="groupName" class="control-label">组名:</label>
                    <div class="controls">
                        <input type="text" id="groupName" name="rolername" class="required" />
                    </div>
                </div>
                <div class="control-group">
                    <label for="groupKey" class="control-label">组类型:</label>
                    <div class="controls">
                        <input type="text" id="groupKey" name="keyname" class="required" />
                    </div>
                </div>
                <div class="control-group">
