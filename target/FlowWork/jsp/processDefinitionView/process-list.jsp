    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.change-state').click(function () {
                ...
                $('#changeStateForm').attr('action', ctx + '/processDef/stopProdef/' + state);
            });
            ...
            $('.set-startable').click(function () {
                ...
                $.getJSON(ctx + '/processDef/startable/read/' + pid, function(result) {
            ...
            $('#addStartableAttr').click(function () {
                ...
                // 发送请求
                $.post(ctx + "/processDef/startable/set/" + processDefinitionId, {
                    users: users,
                    groups: groups
                }, function (resp) {
                    if (resp == 'true') {
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" style="min-width: 100px;margin-left: -50px;">
                        <li><a href='${ctx }/processDef/deleteDeployment.action?deploymentId=${pd.deploymentId }'><i
